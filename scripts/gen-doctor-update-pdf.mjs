// Render docs/handbook/doctor-update.html -> docs/Ramachandra-Ortho-Progress-Update.pdf
...
const SRC = new URL("../docs/handbook/doctor-update.html", import.meta.url).pathname;
const OUT = new URL("../docs/Ramachandra-Ortho-Progress-Update.pdf", import.meta.url).pathname;
const sleep = (ms) => new Promise((r) => setTimeout(r, ms));

const chrome = spawn(CHROME, [
  "--headless=new", "--disable-gpu", "--no-first-run", "--no-default-browser-check",
  `--remote-debugging-port=${PORT}`, "--user-data-dir=/tmp/ortho-doctor-update-pdf-profile", "about:blank",
], { stdio: "ignore" });
