// Render docs/handbook/patient-journey-walkthrough.html -> docs/Ramachandra-Ortho-Patient-Journey-Walkthrough.pdf
...
const SRC = new URL("../docs/handbook/patient-journey-walkthrough.html", import.meta.url).pathname;
const OUT = new URL("../docs/Ramachandra-Ortho-Patient-Journey-Walkthrough.pdf", import.meta.url).pathname;
const sleep = (ms) => new Promise((r) => setTimeout(r, ms));

const chrome = spawn(CHROME, [
  "--headless=new", "--disable-gpu", "--no-first-run", "--no-default-browser-check",
  `--remote-debugging-port=${PORT}`, "--user-data-dir=/tmp/ortho-walkthrough-pdf-profile", "about:blank",
], { stdio: "ignore" });
