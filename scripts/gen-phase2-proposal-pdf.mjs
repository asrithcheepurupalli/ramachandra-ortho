// Render docs/progress/phase2-proposal-deck.html -> docs/Ramachandra-Ortho-Phase-II-Proposal.pdf
...
const SRC = new URL("../docs/progress/phase2-proposal-deck.html", import.meta.url).pathname;
const OUT = new URL("../docs/Ramachandra-Ortho-Phase-II-Proposal.pdf", import.meta.url).pathname;
const sleep = (ms) => new Promise((r) => setTimeout(r, ms));

const chrome = spawn(CHROME, [
  "--headless=new", "--disable-gpu", "--no-first-run", "--no-default-browser-check",
  `--remote-debugging-port=${PORT}`, "--user-data-dir=/tmp/ortho-phase2-pdf-profile", "about:blank",
], { stdio: "ignore" });
