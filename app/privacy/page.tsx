    ...
    <main className="mx-auto w-full max-w-2xl px-5 pb-24 pt-6 md:pb-16">
      ...
      <div className="mt-2">
        ...
        <Section title="Appointment &amp; token policy">
          ...
          <p>The flat consultation fee ({clinic.currency}{clinic.consultationFee}) is payable online when you book. Your slot is held for 15 minutes and confirmed once payment is complete.</p>
        </Section>
