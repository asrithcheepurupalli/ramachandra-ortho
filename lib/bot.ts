...
const P: Record<Lang, PhrasePack> = {
  en: {
    ...
    payDone: (url: string) => `Here's your payment link (valid 15 mins):\n${url}\n\nComplete payment before your slot is released.`,
  ...
  te: {
    ...
    pendingHold: "మీకు ఇప్పటికే చెల్లింపు కోసం వేచి ఉన్న బుకింగ్ ఉంది. మీ స్లాట్ నిర్ధారించడానికి దయచేసి ఇప్పుడే ఆ చెల్లింపు పూర్తి చేయండి. చెల్లించని బుకింగ్ 15 నిమిషాల తర్వాత దానంతట అదే విడుదల అవుతుంది. లేదా *కొత్తగా మొదలుపెట్టండి* నొక్కి రద్దు చేసి కొత్త స్లాట్ బుక్ చేయండి.",
    ...
    payDone: (url: string) => `మీ చెల్లింపు లింక్ (15 నిమిషాలు చెల్లుతుంది):\n${url}\n\nస్లాట్ విడుదల అయ్యేలోపు చెల్లించండి.`,
    ...
    otpExpired: "ఆ కోడ్ గడువు ముగిసింది. కొత్త కోడ్ కోసం *షెడ్యూల్ మార్చండి* నొక్కండి.",
    otpFail: "మీ నంబర్ ఇప్పుడు నిర్ధారించలేకపోయాము. దయచేసి మళ్ళీ ప్రయత్నించండి, లేదా సైట్‌లో *నా అపాయింట్‌మెంట్* తెరవండి.",
  ...
  hi: {
    ...
    payDone: (url: string) => `यह रहा आपका भुगतान लिंक (15 मिनट के लिए मान्य):\n${url}\n\nस्लॉट रिलीज़ होने से पहले भुगतान पूरा करें।`,
...
// ─────────────────────────────────────────────────────────────────────────────
export type Backend = {
  addBooking: (input: { name: string; phone: string; age: number; gender?: "M" | "F" | null; locality?: string | null; date: string; time: string; source?: Source; replacePending?: boolean; claim?: "returning_unverified" | "review_free" }) => Promise<Appt>;
