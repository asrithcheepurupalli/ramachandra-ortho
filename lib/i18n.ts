...
const en: Dict = {
  ...
  "ramu.open": "Ask Ramu",
  "ramu.sub": "Clinic assistant",
  "ramu.greet": "Namaste 🙏 I'm Ramu, your assistant at Ramachandra Ortho Care. I can check if the doctor is in, book you an appointment, or answer common questions. How can I help?",
...
const te: Dict = {
  ...
  "ramu.open": "రాముని అడగండి",
  "ramu.sub": "క్లినిక్ అసిస్టెంట్",
  "ramu.greet": "నమస్కారం 🙏 నేను రాము, Ramachandra Ortho Care అసిస్టెంట్‌ని. డాక్టర్ ఉన్నారో చెప్పగలను, అపాయింట్‌మెంట్ బుక్ చేయగలను, లేదా సాధారణ ప్రశ్నలకు సమాధానం ఇవ్వగలను. ఎలా సహాయపడను?",
...
const hi: Dict = {
  ...
  "ramu.open": "रामू से पूछें",
  "ramu.sub": "क्लिनिक असिस्टेंट",
  "ramu.greet": "नमस्ते 🙏 मैं रामू हूँ, Ramachandra Ortho Care का असिस्टेंट। मैं बता सकता हूँ कि डॉक्टर उपलब्ध हैं या नहीं, अपॉइंटमेंट बुक कर सकता हूँ, या सामान्य सवालों के जवाब दे सकता हूँ। कैसे मदद करूँ?",
